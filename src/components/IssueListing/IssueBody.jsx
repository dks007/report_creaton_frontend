  ...
  return (
    <>
      <tr className={`table ${dynamicClass}`}>
        ...
        <td className="menu-id-col"><div>{issue.menu_id}</div></td>
        <td className="menu-des-col"><Tooltip title="{issue.menu_desc}" placement="bottom"><div>{issue.menu_desc}</div></Tooltip></td>
        <td className="ticket-des-col"><div>{issue.ticket_desc}</div></td>
        <td className="sdo-col"><div>{issue.sdo}</div></td>
        <td className="sdm-col"><div>{issue.sdm}</div></td>
        <td className="csm-col"><div>{issue.csm}</div></td>

...
const LicenseAnalyzer = ({ displayName }) => {
  return (
    <div className="home-page">
      ...
      <div>
      <iframe title="STA - License Analyzer" className='success-analyzer-api' src="https://app.powerbi.com/reportEmbed?reportId=39ec5292-7c7d-4ffa-91e1-f925f03cd339&autoAuth=true&ctid=afadec18-0533-4cba-8578-5316252ff93f" frameborder="0" allowFullScreen="true"></iframe>
      </div>
    </div>
  )
}
